...
export const GETTING_STARTED_STEPS = [
	...
	{
		message: 'Time to have a look at <b>Task</b>',
		hint: 'Open <a href="/task" target="_blank">the TASK app</a> and connect wallet to use app🐰',
	},
	{
		message:
			'<b>Congratulations!</b> You are now familiar with the basics! 🎉',
